...
func Encode(writer io.Writer, pcm []byte, format saprobe.PCMFormat) error {
...
func deinterleave(pcm []byte, offset, blockSize, nChannels int, depth saprobe.BitDepth) [][]int32 {
...
func buildFrame(channels [][]int32, blockSize int, format saprobe.PCMFormat) *frame.Frame {
